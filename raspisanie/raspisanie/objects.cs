...
{
    public partial class objects : MaterialSkin.Controls.MaterialForm
    {
        public objects()
        {
            InitializeComponent();
        ...
        {
            con.Open();
            MySqlCommand cmd = new MySqlCommand("slob", con);
        ...
        private void materialRaisedButton1_Click(object sender, EventArgs e)
        {
            ...
            myConn.Open();
            MySqlCommand cmd = new MySqlCommand("call addobjects(@oname, @tid, @count)", myConn);

            MySqlParameter MC = new MySqlParameter();
            MC = cmd.Parameters.Add("oname", MySqlDbType.VarChar, 45);
            ...
            QT = cmd.Parameters.Add("tid", MySqlDbType.VarChar, 45);
        ...
        private void materialRaisedButton2_Click(object sender, EventArgs e)
        {
            ...
            MySqlConnection myConn = new MySqlConnection(myConnection);
            myConn.Open();
            MySqlCommand cmd = new MySqlCommand("call dellobjects(@id)", myConn);
        ...
        private void materialRaisedButton3_Click(object sender, EventArgs e)
        {
            ...
            MySqlConnection myConn = new MySqlConnection(myConnection);
            myConn.Open();
            MySqlCommand cmd = new MySqlCommand("call updObjects(@id, @oname, @tid, @count)", myConn);
            ...
            MS = cmd.Parameters.Add("oname", MySqlDbType.VarChar, 45);
            ...
            DC = cmd.Parameters.Add("tid", MySqlDbType.VarChar, 45);
